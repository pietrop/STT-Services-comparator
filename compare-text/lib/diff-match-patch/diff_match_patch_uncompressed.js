...
// modified to work for words rather then char as explaoned here https://github.com/google/diff-match-patch/wiki/Line-or-Word-Diffs
...
var diff_match_patch = function() {
  ...
  diff_match_patch.prototype.diff_linesToChars_ = function(text1, text2) {
    ...
    function diff_linesToCharsMunge_(text) {
      ...
      while (lineEnd < text.length - 1) {
        // TODO: https://github.com/google/diff-match-patch/wiki/Line-or-Word-Diffs
  ...
  diff_match_patch.prototype.diff_cleanupSemantic = function(diffs) {
    ...
    // NOTE: added a return to modified diff to this function
    return diffs;
  };
